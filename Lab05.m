...
figure(1);
plot(t(1:200),signal(1:200),'Color',[0 0.4470 0.7410]) % blue
set(gca,'ytick',[-1.0 0 1.0])
title('A segment of synthetically generated sinusiodal waveform')
grid on
xlabel('time(sec)');
...
figure(2);
stairs(time(1:500),baseband(1:500),'Color',[0.8500 0.3250 0.0980]) % orange
...
figure(3)
subplot(2,1,1)
plot(time(1:100),signal(1:100),'Color',[0.4660 0.6740 0.1880]) % green
set(gca,'ytick',[-1.0 0 1.0])
axis([0,time(100),-1,1])
...
subplot(2,1,2)
plot(time(1:100),sample_value(1:100),'Color',[0.6350 0.0780 0.1840]) % dark red
axis([0,time(100),-1,1])
set(gca,'ytick',[-1.0 0 1.0])
