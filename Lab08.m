...
figure(1);
plot(t(1:200),signal(1:200), 'Color', [0 0.4470 0.7410], 'LineWidth', 1.5) % blue line
...
time=[0:Tb:1];
figure(2);
stairs(time(1:500),baseband(1:500), 'Color', [0.8500 0.3250 0.0980], 'LineWidth', 1.5) % orange line
...
figure(3)
subplot(2,1,1)
plot(time(1:100),signal(1:100), 'Color', [0 0.4470 0.7410], 'LineWidth', 1.5) % blue line
set(gca,'ytick',[ -1.0   0 1.0 ])
axis([0,time(100),-1,1])
...
grid on
subplot(2,1,2)
plot(time(1:100),sample_value(1:100), 'Color', [0.8500 0.3250 0.0980], 'LineWidth', 1.5) % orange line
axis([0,time(100),-1,1])
set(gca,'ytick',[ -1.0   0 1.0 ])
